...
const FeatureSection = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-10 overflow-hidden'>
        <div className='relative flex items-center justify-between pt-20 pb-10'>
            <BlurCircle top="0" right='-80px' />
            <p className='text-gray-300 font-medium text-lg'>Now Showing</p>
            <button onClick={()=>navigate('/movies')} className='group flex 
            items-center gap-2 text-sm text-gray-300 cursor'>
                View All
        ...
        <div className='flex justify-center mt-20'> 
          ...
          className='px-10 py-3 text-sm bg-primary hover:bg-primary/90 transition
