...
const MovieDetails = () => {
  ...
  return show? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      rounded-xl h-90 max-w-70 object-cover'/>
      <div className='relative flex flex-col gap-3'>
        ...
        <div className='flex items-center flex-wrap gap-4 mt-4'>
          ...
          hover:bg-primary/90 transition rounded-md font-medium cursor-pointer
          activate:scale-95'>Buy Tcikets</a>
          <button className='bg-gray-700 o-2.5 rounded-full transition
          cursor-pointer active:scale-95'>
          ...
          <div className='flex items-center gap-4 w-max px-4'>
            {show.movie.casts.slice(0,12).map((cast,index)=>(
              <div key={index} className='flex flex-col items-center text-center'>
                ...
                md:h-29 aspect-square object-cover'/>
